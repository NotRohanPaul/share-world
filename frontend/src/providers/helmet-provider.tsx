        ...
        {(IS_SECURE_ENV === false) ? null :
            <Helmet prioritizeSeoTags={true}>
                ...
                <meta http-equiv="Content-Security-Policy"
                    content={`default-src 'self'; script-src 'self'; object-src 'none'; style-src 'self' 'unsafe-inline'; img-src 'self' data:; font-src 'self'; connect-src 'self' ${API_ORIGIN}; form-action 'self'; base-uri 'self';`} />
            </Helmet>}
        {children}
    </HelmetProvider>
);